...
public class TransactionManager {
    ...
    // Concatenate printing information such as printing message, item info and all
    ...
    public String printItemTransaction(String itemID, String itemInfo) {
        ...
        if (totalNumberOfTransaction(itemID) == 0) {
            ...
            printTransaction = printTransaction + itemInfo + s + "No transactions have been registered for item "
                    + itemID + " yet.";
        } else {
